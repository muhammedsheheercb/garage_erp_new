      ...
      <div className="max-w-3xl mx-auto border border-gray-200 p-8 print:border-none print:p-0">
        ...
        <div className="flex justify-between items-start mb-8 pb-8 border-b border-gray-200">
          ...
          <div className={`text-${isRTL ? 'left' : 'right'}`}>
            ...
            <p className="text-sm text-gray-500 mt-2 font-medium">{t.invoicesMod.date || 'Date'}: {new Date(job.createdAt).toLocaleDateString(locale === 'ar' ? 'ar-EG' : 'en-US')} {new Date(job.createdAt).toLocaleTimeString(locale === 'ar' ? 'ar-EG' : 'en-US')}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">{job.expectedFinishDate ? new Date(job.expectedFinishDate).toLocaleDateString(locale === 'ar' ? 'ar-EG' : 'en-US') : (isRTL ? 'غير محدد' : 'Not set')}</p>
          </div>
        </div>
