export const en = {
  ...
  vehicles: {
    ...
    companiesTitle: "Vehicle Companies & Models",
    companiesDescription: "Create and manage vehicle manufacturers and their models.",
  ...
  jobcards: {
    ...
    advancePaid: "Advance Amount Paid",
    advanceExceedsTotal: "Advance amount cannot exceed the total amount",
  ...
  payments: {
    ...
    searchPendingInvoices: "Search by customer or vehicle number...",
  ...
  purchases: {
    ...
    downloadInvoice: "Download Purchase Invoice",
    printInvoice: "Print Purchase Invoice",
